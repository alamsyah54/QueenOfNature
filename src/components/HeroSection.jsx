...
const HeroSection = () => {
    return (
        <div className='relative items-center justify-center py-24'>
            <section className='relative w-full md:flex lg:flex lg:items-center mt-28 pt-10 lg:px-28 lg:mt-16'>
                {/* MAIN SHAMPOO PICTURE START */}
                <div className='flex justify-center items-center md:w-[80%] lg:mb-5 md:mb-5 mb-24'>
                    <img
                        src={HeroImages}
                        alt=''
